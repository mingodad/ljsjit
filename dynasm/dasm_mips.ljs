...
var mips64 = mips64;
var mipsr6 = _map_def.MIPSR6;

// Module information:
var _info = {
  arch =	mips64 && "mips64" || "mips",
...
var assert, setmetatable = assert, setmetatable;
var _s = string;
var sub, format, byte, char = _s.sub, _s.format, _s.byte, _s.char;
var match, gmatch = _s.match, _s.gmatch;
var concat, sort = table.concat, table.sort;
...
var function waction(action, val, a, num) {
  ...
  wputxw(0xff000000 + w * 0x10000 + (val || 0));
...
// Arch-specific maps.
var map_archdef = { sp="r29", ra="r31" }; // Ext. register name -> int. name.
...
var map_op = {
  ...
  xori_3 =	"38000000TSU",
  lui_2 =	"3c000000TU",
  daddiu_3 =	mips64 && "64000000TSI",
  ldl_2 =	mips64 && "68000000TO",
  ldr_2 =	mips64 && "6c000000TO",
  lb_2 =	"80000000TO",
  lh_2 =	"84000000TO",
  lw_2 =	"8c000000TO",
  lbu_2 =	"90000000TO",
  lhu_2 =	"94000000TO",
  lwu_2 =	mips64 && "9c000000TO",
  sb_2 =	"a0000000TO",
  sh_2 =	"a4000000TO",
  sw_2 =	"ac000000TO",
  lwc1_2 =	"c4000000HO",
  ldc1_2 =	"d4000000HO",
  ld_2 =	mips64 && "dc000000TO",
  swc1_2 =	"e4000000HO",
  sdc1_2 =	"f4000000HO",
  sd_2 =	mips64 && "fc000000TO",
  ...
  break_1 =	"0000000dY",
  sync_0 =	"0000000f",
  dsllv_3 =	mips64 && "00000014DTS",
  dsrlv_3 =	mips64 && "00000016DTS",
  dsrav_3 =	mips64 && "00000017DTS",
  add_3 =	"00000020DST",
  move_2 =	mips64 && "00000025DS" || "00000021DS",
  addu_3 =	"00000021DST",
  sub_3 =	"00000022DST",
  negu_2 =	mips64 && "0000002fDT" || "00000023DT",
  subu_3 =	"00000023DST",
  and_3 =	"00000024DST",
  or_3 =	"00000025DST",
  xor_3 =	"00000026DST",
  ...
  slt_3 =	"0000002aDST",
  sltu_3 =	"0000002bDST",
  dadd_3 =	mips64 && "0000002cDST",
  daddu_3 =	mips64 && "0000002dDST",
  dsub_3 =	mips64 && "0000002eDST",
  dsubu_3 =	mips64 && "0000002fDST",
  tge_2 =	"00000030ST",
  tge_3 =	"00000030STZ",
  tgeu_2 =	"00000031ST",
  tgeu_3 =	"00000031STZ",
  ...
  tne_2 =	"00000036ST",
  tne_3 =	"00000036STZ",
  dsll_3 =	mips64 && "00000038DTa",
  dsrl_3 =	mips64 && "0000003aDTa",
  drotr_3 =	mips64 && "0020003aDTa",
  dsra_3 =	mips64 && "0000003bDTa",
  dsll32_3 =	mips64 && "0000003cDTA",
  dsrl32_3 =	mips64 && "0000003eDTA",
  drotr32_3 =	mips64 && "0020003eDTA",
  dsra32_3 =	mips64 && "0000003fDTA",
  ...
  dextm_4 =	mips64 && "7c000001TSAM", // Args: pos    | size-1-32
  dextu_4 =	mips64 && "7c000002TSAM", // Args: pos-32 | size-1
  dext_4 =	mips64 && "7c000003TSAM", // Args: pos    | size-1
  zextw_2 =	mips64 && "7c00f803TS",
  ins_4 =	"7c000004TSAM", // Note: last arg is msb = pos+size-1
  dinsm_4 =	mips64 && "7c000005TSAM", // Args: pos    | pos+size-33
  dinsu_4 =	mips64 && "7c000006TSAM", // Args: pos-32 | pos+size-33
  dins_4 =	mips64 && "7c000007TSAM", // Args: pos    | pos+size-1
  wsbh_2 =	"7c0000a0DT",
  dsbh_2 =	mips64 && "7c0000a4DT",
  dshd_2 =	mips64 && "7c000164DT",
  seb_2 =	"7c000420DT",
  seh_2 =	"7c000620DT",
  rdhwr_2 =	"7c00003bTD",
  ...
  mfc0_2 =	"40000000TD",
  mfc0_3 =	"40000000TDW",
  dmfc0_2 =	mips64 && "40200000TD",
  dmfc0_3 =	mips64 && "40200000TDW",
  mtc0_2 =	"40800000TD",
  mtc0_3 =	"40800000TDW",
  dmtc0_2 =	mips64 && "40a00000TD",
  dmtc0_3 =	mips64 && "40a00000TDW",
  rdpgpr_2 =	"41400000DT",
  di_0 =	"41606000",
  di_1 =	"41606000T",
  ei_0 =	"41606020",
  ...
  // Opcode COP1.
  mfc1_2 =	"44000000TG",
  dmfc1_2 =	mips64 && "44200000TG",
  cfc1_2 =	"44400000TG",
  mfhc1_2 =	"44600000TG",
  mtc1_2 =	"44800000TG",
  dmtc1_2 =	mips64 && "44a00000TG",
  ctc1_2 =	"44c00000TG",
  mthc1_2 =	"44e00000TG",
...
if( mipsr6 ) { // Instructions added with MIPSR6.

  for( k,v in pairs({

    // Add immediate to upper bits.
    aui_3 =	"3c000000TSI",
    daui_3 =	mips64 && "74000000TSI",
    dahi_2 =	mips64 && "04060000SI",
    dati_2 =	mips64 && "041e0000SI",
    ...
    sdbbp_1 =	"0000000eY",
    lsa_4 =	"00000005DSTA",
    dlsa_4 =	mips64 && "00000015DSTA",
    seleqz_3 =	"00000035DST",
    selnez_3 =	"00000037DST",
    clz_2 =	"00000050DS",
    clo_2 =	"00000051DS",
    dclz_2 =	mips64 && "00000052DS",
    dclo_2 =	mips64 && "00000053DS",
    mul_3 =	"00000098DST",
    muh_3 =	"000000d8DST",
    mulu_3 =	"00000099DST",
    muhu_3 =	"000000d9DST",
    ...
    divu_3 =	"0000009bDST",
    modu_3 =	"000000dbDST",
    dmul_3 =	mips64 && "0000009cDST",
    dmuh_3 =	mips64 && "000000dcDST",
    dmulu_3 =	mips64 && "0000009dDST",
    dmuhu_3 =	mips64 && "000000ddDST",
    ddiv_3 =	mips64 && "0000009eDST",
    dmod_3 =	mips64 && "000000deDST",
    ddivu_3 =	mips64 && "0000009fDST",
    dmodu_3 =	mips64 && "000000dfDST",

    // Opcode SPECIAL3.
    align_4 =		"7c000220DSTA",
    dalign_4 =		mips64 && "7c000224DSTA",
    bitswap_2 =		"7c000020DT",
    dbitswap_2 =	mips64 && "7c000024DT",
  ...
  for( k,v in pairs({
    ...
    lwr_2 =	"98000000TO",
    swl_2 =	"a8000000TO",
    sdl_2 =	mips64 && "b0000000TO",
    sdr_2 =	mips64 && "b1000000TO",
    swr_2 =	"b8000000TO",
    cache_2 =	"bc000000NO",
    ll_2 =	"c0000000TO",
    pref_2 =	"cc000000NO",
    sc_2 =	"e0000000TO",
    scd_2 =	mips64 && "f0000000TO",
    ...
    div_3 =	"0000001aST",
    divu_3 =	"0000001bST",
    ddiv_3 =	mips64 && "0000001eST",
    ddivu_3 =	mips64 && "0000001fST",
    dmult_2 =	mips64 && "0000001cST",
    dmultu_2 =	mips64 && "0000001dST",
    ...
    clz_2 =	"70000020D=TS",
    clo_2 =	"70000021D=TS",
    dclz_2 =	mips64 && "70000024D=TS",
    dclo_2 =	mips64 && "70000025D=TS",
    sdbbp_0 =	"7000003f",
    sdbbp_1 =	"7000003fY",
...
var function parse_gpr(expr) {
  var tname, ovreg = match(expr, "^([%w_]+):(r[1-3]?[0-9])$");
...
var function parse_fpr(expr) {
  var r = match(expr, "^f([1-3]?[0-9])$");
  if( r ) {
    r = tonumber(r);
    if( r <= 31 ) { return r; }
  }
...
var function parse_imm(imm, bits, shift, scale, signed, action) {
  var n = tonumber(imm);
  if( n ) {
    var m = sar(n, scale);
    if( shl(m, scale) == n ) {
  ...
  } else if( match(imm, "^[rf]([1-3]?[0-9])$") ||
	 match(imm, "^([%w_]+):([rf][1-3]?[0-9])$") ) {
    werror("expected immediate operand, got register");
  } else {
    waction(action || "IMM",
	    (signed && 32768 || 0)+shl(scale, 10)+shl(bits, 5)+shift, imm);
    return 0;
  }
}

var function parse_disp(disp) {
  var imm, reg = match(disp, "^(.*)%(([%w_:]+)%)$");
  if( imm ) {
    var r = shl(parse_gpr(reg), 21);
    var extname = match(imm, "^extern%s+(%S+)$");
    if( extname ) {
      waction("REL_EXT", map_extern[extname], null, 1);
      return r;
    } else {
  ...
  var tailr;
  reg, tailr = match(disp, "^([%w_:]+)%s*(.*)$");
  if( reg && tailr != "" ) {
    var r, tp = parse_gpr(reg);
    if( tp ) {
...
var function parse_index(idx) {
  var rt, rs = match(idx, "^(.*)%(([%w_:]+)%)$");
  if( rt ) {
    rt = parse_gpr(rt);
    rs = parse_gpr(rs);
...
map_op[".template__"] = function(params, template, nparams) {
  if( ! params ) { return sub(template, 9); }
  ...
  for( p in gmatch(sub(template, 9), ".") ) {
    if( p == "D" ) {
      op +=   shl(parse_gpr(params[n]), 11); n +=   1;
    } else if( p == "T" ) {
      op +=   shl(parse_gpr(params[n]), 16); n +=   1;
    } else if( p == "S" ) {
      op +=   shl(parse_gpr(params[n]), 21); n +=   1;
    } else if( p == "F" ) {
      op +=   shl(parse_fpr(params[n]), 6); n +=   1;
    } else if( p == "G" ) {
      op +=   shl(parse_fpr(params[n]), 11); n +=   1;
    } else if( p == "H" ) {
      op +=   shl(parse_fpr(params[n]), 16); n +=   1;
    } else if( p == "R" ) {
      op +=   shl(parse_fpr(params[n]), 21); n +=   1;
    } else if( p == "I" ) {
      op +=   parse_imm(params[n], 16, 0, 0, true); n +=   1;
    } else if( p == "U" ) {
      op +=   parse_imm(params[n], 16, 0, 0, false); n +=   1;
    } else if( p == "O" ) {
      op +=   parse_disp(params[n]); n +=   1;
    } else if( p == "X" ) {
      op = op + parse_index(params[n]); ++n    ;
    } else if( p == "B" || p == "J" || p == "K" || p == "L" ) {
      var mode, m, s = parse_label(params[n], false);
      if( p == "J" ) { m +=   0xa800;
      } else if( p == "K" ) { m +=   0x5000;
      } else if( p == "L" ) { m +=   0xa000; }
      waction("REL_"..mode, m, s, 1);
      n +=   1;
    } else if( p == "A" ) {
      op +=   parse_imm(params[n], 5, 6, 0, false); n +=   1;
    } else if( p == "a" ) {
      var m = parse_imm(params[n], 6, 6, 0, false, "IMMS"); n +=   1;
      op +=   band(m, 0x7c0) + band(shr(m, 9), 4);
    } else if( p == "M" ) {
      op +=   parse_imm(params[n], 5, 11, 0, false); n +=   1;
    } else if( p == "N" ) {
      op +=   parse_imm(params[n], 5, 16, 0, false); n +=   1;
    } else if( p == "C" ) {
      op +=   parse_imm(params[n], 3, 18, 0, false); n +=   1;
    } else if( p == "V" ) {
      op +=   parse_imm(params[n], 3, 8, 0, false); n +=   1;
    } else if( p == "W" ) {
      op +=   parse_imm(params[n], 3, 0, 0, false); n +=   1;
    } else if( p == "Y" ) {
      op +=   parse_imm(params[n], 20, 6, 0, false); n +=   1;
    } else if( p == "Z" ) {
      op +=   parse_imm(params[n], 10, 6, 0, false); n +=   1;
    } else if( p == "=" ) {
